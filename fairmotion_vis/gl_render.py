...
def render_cone(p1, p2, r=0.1, color=[1.0, 0.5, 0.0]):
	glColor(color)
	height = np.linalg.norm(np.array(p2) - np.array(p1))  # height of the cone
	...
	gluCylinder(quadric, r, 0, height, slices, stacks)
